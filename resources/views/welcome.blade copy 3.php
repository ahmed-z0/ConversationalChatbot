...
$(document).ready(function() {
 ...
 stopCurrentAudio(); // Prepare environment for new response
    ...
    // let aiResponseBuffer = "";
        ...
        source.addEventListener("update",  function (event) {
            if (event.data === "<END_STREAMING_SSE>") {
                ...
                convertTextToSpeech(aiResponseBuffer); // Enqueue any remaining text for TTS
                aiResponseBuffer = ""; // Clear buffer after enqueuing
            } else {
                ...
                // processAccumulatedText(); // Process for possible sentence ends
